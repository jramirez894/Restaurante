...
{
    Context context;
    ArrayList<ItemsDatosProductos> imagenes;
    int background;
    ...
    public GalleryAdapter(Context context, ArrayList<ItemsDatosProductos> imagenes )
    {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        {
            Bitmap bitmap = BitmapUtils.decodeSampledBitmapFromResource(context.getResources(), imagenes.get(position).getImagen(),
                    120, 0);
